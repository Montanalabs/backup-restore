...
- `backup-restore_safe.wave` — the correct design.
- `backup-restore_unsafe.wave` — the tempting-but-wrong version (the negative example a model must learn to reject).
